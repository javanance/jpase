...
//  Out of date!!! 
public class WepScrapUtil {
	private static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(WepScrapUtil.class);
	 ...
	 */
	/*public static String getListJson(UrlMenu ksdMenu, Map<String, String> data) {
		return getListJson(ksdMenu.getReferer(), ksdMenu.getPayload(),filterParameters(ksdMenu, data), "result", "value");
	}

	public static String getListJson(UrlMenu ksdMenu, Map<String, String> data, String elementName, String attrName) {
	...
	*//**
	...
	public static String getListJson(String url, String referer, String payload, Map<String, String> data, String elementName,String attrName) {
		List<Element> results = getDocument(url, referer, payload, data).select(elementName);
		StringBuffer strBuffer = new StringBuffer();
	...
	public static  Document getDocument(String url, String referer, String payload, Map<String, String> data) {
//		logger.info("payload : {},{}", referer, StrSubstitutor.replace(payload, data));
	...
	public static <E> List<E> convertTo(UrlMenu ksdMenu, String jsonString) {
		try {
	...
	/*public static <E> List<E> convertTo(UrlMenu ksdMenu, Map<String, String> data) {
...
//		String jsonString = getListJson(ksdMenu, data);
	...
	private static Map<String, String> filterParameters(UrlMenu ksdMenu,  Map<String, String> rawData){
